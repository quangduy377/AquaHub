...
const CardianaParameters = [
  { label: "TDS", value: "100 – 120 ppm" },
  { label: "GH", value: "3 – 6 dGH" },
  { label: "KH", value: "0 – 1 dKH" },
  { label: "pH", value: "5.0 – 6.0" },
  { label: "Temperature", value: "21 – 23 °C" },
];
